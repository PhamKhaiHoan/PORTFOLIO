<template>
  <main v-if="!loading" id="hello">
    ...
    <section
      data-aos="fade-up"
      class="game w-full h-full flex items-center justify-center overflow-visible"
      v-if="!isMobile"
    >
      <div class="relative">
        <img
          ...
          class="absolute -top-[240px] -right-[-400px] w-[300px] h-[400px] max-w-none object-cover opacity-90 rounded-2xl  z-0 rotate-[-10deg] hover:blur-none transition-all duration-500"
        />
