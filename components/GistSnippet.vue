<template>
    <div class="gist mb-5" v-if="dataFetched">
        ...
        <div class="flex justify-between my-2">
            ...
            <div class="flex">
                <!-- avatar -->
                <img :src="'/images/WaterMark.png'" alt="" class="w-8 h-8 rounded-full mr-2">
    
                <!-- username & gist date info -->
                <div class="flex flex-col">
                    <a id="username" :href="'https://github.com/PhamKhaiHoan'" target="_blank" class="font-fira_bold text-purple-text text-xs pb-1 hover:cursor-pointer">
                        @AsE
                    </a>
